...
import {
    TouchableOpacity, StyleSheet, Text, TouchableWithoutFeedback
} from 'react-native'
...
class Button extends Component {
    render() {
        ...
        return (
            <TouchableOpacity activeOpacity={1.0} onPress={ this.props.onPress } style={[ styles.default, styles[type], this.props.style || {} ]}>
